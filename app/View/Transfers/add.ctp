<ul class="breadcrumb">
    <li><?php echo $this->Html->link(__('Transfers'), array('action' => 'index')); ?> <span class="divider">/</span></li>
    <li class="active">Download de itens</li>
</ul>
...
<script>
    ...
    function loadlink(){
        ...
        //$.ajax({url: "http://servidor/portalqualidade/devices/uploadDevice", success: function(result){
            ...
            qrcode.makeCode('http://192.168.0.153/portalqualidade/transfers/uploadAjax/');
            //qrcode.makeCode('http://tecplaner.poweredbyclear.com:8080/portalqualidade/transfers/uploadAjax/');
            
            //qrcode.makeCode('http://192.168.0.163/portalqualidade/transfers/appUpdate/');
        //}});
    }
</script>