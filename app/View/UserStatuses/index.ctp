<div class="userStatuses index">
	...
	<tr>
		...
		<td><?php echo h($userStatus['UserStatus']['cssClass']); ?>&nbsp;</td>
		<td><?php echo h($userStatus['UserStatus']['created']); ?>&nbsp;</td>
		<td><?php echo h($userStatus['UserStatus']['modified']); ?>&nbsp;</td>
		<td><?php echo h($userStatus['UserStatus']['user_modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userStatus['UserStatus']['id']), array(), __('Are you sure you want to delete # %s?', $userStatus['UserStatus']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
