<div class="measurements index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('transfer_id'); ?></th>
			<th><?php echo $this->Paginator->sort('cheched'); ?></th>
	...
	<tr>
		<td><?php echo h($measurement['Measurement']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($measurement['Measurement']['cheched']); ?>&nbsp;</td>
		<td><?php echo h($measurement['Measurement']['note']); ?>&nbsp;</td>
		<td><?php echo h($measurement['Measurement']['created']); ?>&nbsp;</td>
		<td><?php echo h($measurement['Measurement']['modified']); ?>&nbsp;</td>
		<td><?php echo h($measurement['Measurement']['user_modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $measurement['Measurement']['id']), array(), __('Are you sure you want to delete # %s?', $measurement['Measurement']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
