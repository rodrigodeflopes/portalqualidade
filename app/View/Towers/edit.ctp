...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="well">
            ...
            <div class="row-fluid">
                <div class="pull-left" style='position:relative;'>
                    <?php echo $this->Html->image($this->data['Tower']['image_path'], array('class' => 'img-building')); ?>
        ...
        <?php echo $this->Form->create('Tower', array('action' => 'delete', $this->data['Tower']['id'])); ?>
        ...
        <?php echo $this->Form->create('Tower', array('action' => 'image_edit/' . $this->data['Tower']['id'], 'type' => 'file')); ?>
            <div class="modal small hide fade" id="FotoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row-fluid">
                            ...
                            <?php echo $this->Form->input('image_path', array('type' => 'hidden', 'value' => $this->data['Tower']['image_path']));  ?>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</button>
